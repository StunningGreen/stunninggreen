    ...
    return (
        ...
        <div class="py-16 bg-yellow-50">
            <div class="container m-auto px-6 text-gray-500 md:px-12 xl:px-0">
                <div class="container m-auto p-3 md:px-">
                    <h1 class="text-4xl font-semibold text-green-700">How It Works</h1>
                </div>
                <div class="mx-auto grid gap-6 md:w-3/4 lg:w-full lg:grid-cols-3">
                    <div class="bg-white rounded-2xl shadow-xl px-8 py-12 sm:px-12 lg:px-8">
                        <div class="mb-12 space-y-4">
                            <h3 class="text-2xl font-semibold text-purple-900">Plugin</h3>
                            <p class="mb-6">Use our BIM plugin to calculate the carbon emission savings you achieve in your renovation project by automatically comparing the existitng building's data with the proposal and enhance your design by focusing on the green transition.</p>
