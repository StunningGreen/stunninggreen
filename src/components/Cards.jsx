...
import {cardImage1, cardImage2, cardImage3} from '../utils/Images'
            ...
            <div class="container grid max-w-screen-xl gap-8 lg:grid-cols-2 lg:grid-rows-2">
                ...
                <div class="flex rounded-md border border-slate-200 bg-white">
                    ...
                    <div class=" hidden h-full w-1/3 overflow-hidden lg:block">
                        <div class=" inset-0">
                            <img src={cardImage2} class="h-full w-full object-cover object-left-top" alt="" />
                        </div>
                    </div>
                </div>
                <div class="flex rounded-md border border-slate-200 bg-white">
                    ...
                    <div class=" hidden h-full w-1/3 overflow-hidden lg:block">
                        <div class=" inset-0">
                            <img src={cardImage3} class="h-full w-full object-cover object-left-top" alt="" />
                        </div>
                    </div>
                </div>
            </div>
